 ...
 */
public class BasicMotorConfigOld {
     ...
     */
    public BasicMotorConfigOld copy(BasicMotorConfigOld copy) {
     ...
     * @return A new instance of BasicMotorConfig with the same values as this instance with no references to the original instance.
     */
    public BasicMotorConfigOld copy() {
        return copy(new BasicMotorConfigOld());
    }
    ...
    public static class PIDConfig {
         ...
         */
        public double iMaxAccum = MotorManager.getConfig().DEFAULT_MAX_OUTPUT;
        /**
    ...
    public static class ConstraintsConfig {
         ...
         */
        public double maxOutput = MotorManager.getConfig().DEFAULT_MAX_OUTPUT;
         ...
         * This is used to save power, relax the mechanism, and prevent damage to the motor.
         */
        public double minOutput = -MotorManager.getConfig().DEFAULT_MAX_OUTPUT;
        /**
