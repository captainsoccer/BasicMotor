 ...
 */
public class TalonSRXMeasurements extends Measurements {
    /**
     ...
     * @see TalonSRX#configSelectedFeedbackSensor(FeedbackDevice)
     */
    public TalonSRXMeasurements(TalonSRX talonSRX, double tickPerRevolution, double gearRatio, double unitConversion) {
     ...
     * @see TalonSRX#configSelectedFeedbackSensor(FeedbackDevice)
     */
    public TalonSRXMeasurements(TalonSRX talonSRX, double tickPerRevolution, double gearRatio) {
     ...
     * @see TalonSRX#configSelectedFeedbackSensor(FeedbackDevice)
     */
    public TalonSRXMeasurements(TalonSRX talonSRX, double tickPerRevolution) {
