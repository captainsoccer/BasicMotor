...
public class ConstraintsGains {
    ...
    public ConstraintsGains(ConstraintType type, double minValue, double maxValue, double maxMotorOutput, double minMotorOutput, double deadband, double rampRate) {
        ...
        this.maxMotorOutput = Math.max(maxMotorOutput, 0);
        this.minMotorOutput = Math.min(-Math.abs(maxMotorOutput), 0);
    ...
    public ConstraintsGains(ConstraintType type, double minValue, double maxValue) {
        this(type, minValue, maxValue, MotorManager.getConfig().DEFAULT_MAX_OUTPUT, -MotorManager.getConfig().DEFAULT_MAX_OUTPUT, 0, 0);
    }
    ...
    public ConstraintsGains(ConstraintType type, double minValue, double maxValue, double voltageDeadband) {
        this(type, minValue, maxValue, MotorManager.getConfig().DEFAULT_MAX_OUTPUT, -MotorManager.getConfig().DEFAULT_MAX_OUTPUT, voltageDeadband, 0);
    }
    ...
    public ConstraintsGains(double voltageDeadband) {
        this(MotorManager.getConfig().DEFAULT_MAX_OUTPUT, -MotorManager.getConfig().DEFAULT_MAX_OUTPUT, voltageDeadband);
    }
    ...
    public ConstraintsGains() {
        this(MotorManager.getConfig().DEFAULT_MAX_OUTPUT, -MotorManager.getConfig().DEFAULT_MAX_OUTPUT);
    }
