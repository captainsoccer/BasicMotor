...
public class VictorSPXInterface extends MotorInterface {
    ...
    public VictorSPXInterface(int id, String name, Measurements defaultMeasurements) {
        ...
        motor.configVoltageCompSaturation(MotorManager.getConfig().DEFAULT_IDEAL_VOLTAGE);
    ...
    public void updateConstraintsGainsToMotor(ConstraintsGains constraints) {
        ...
        motor.configPeakOutputForward(constraints.getMaxMotorOutput() / MotorManager.getConfig().DEFAULT_IDEAL_VOLTAGE);
        motor.configPeakOutputReverse(-constraints.getMaxMotorOutput() / MotorManager.getConfig().DEFAULT_IDEAL_VOLTAGE);

        motor.configNominalOutputForward(constraints.getVoltageDeadband() / MotorManager.getConfig().DEFAULT_IDEAL_VOLTAGE);
        motor.configNominalOutputReverse(-constraints.getVoltageDeadband() / MotorManager.getConfig().DEFAULT_IDEAL_VOLTAGE);
