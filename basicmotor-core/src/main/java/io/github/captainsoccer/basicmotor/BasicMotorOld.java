 ...
 */
public abstract class BasicMotorOld {
    /**
     ...
     */
    protected BasicMotorOld(MotorInterface motorInterface, BasicMotorConfig config) {
     ...
     */
    public final void followMotor(BasicMotorOld master, boolean inverted) {
    ...
    private double getCurrentFromTorque(double torque) {
        if (config == null) {
            errorHandler.logError("Trying to convert torque and current without config set.");
            return 0;
        }
